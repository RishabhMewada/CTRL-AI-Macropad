 # ================================
# CTRL Macro Pad Firmware v2.3
# AI-Ready Programmable Macro Pad
# Corrected GPIO pins - NO CONFLICTS
# ================================
...
class Config:
    ...
    # Rotary Encoder
    ENCODER_A = board.GP14      # RE-1 (also encoder switch SW2)
    ENCODER_B = board.GP15      # RE-2
    ENCODER_SW = board.GP14     # Encoder push button (SW1 to GND, SW2 to GP14)
...
# ----------------
# Note: Encoder has built-in push switch
# SW1 connects to GND, SW2 connects to GP14
# When pressed, GP14 is pulled LOW (requires pull-up resistor)
encoder_module.pins = (
    (Config.ENCODER_A, Config.ENCODER_B, Config.ENCODER_SW),  # GP14, GP15, GP14 (with switch)
)
...
# ----------------
# Format: (CW_rotation, CCW_rotation, Button_press) for each layer
encoder_module.map = [
    # Layer 0: Volume control + Mute
    ((KC.VOLU, KC.VOLD, KC.MUTE),),
    
    # Layer 1: Horizontal scroll + Enter
    ((KC.RIGHT, KC.LEFT, KC.ENTER),),
    
    # Layer 2: Zoom + Reset Zoom
...
print(f"  Encoder Switch: GP{Config.ENCODER_SW.id} (SW2 to GP14, SW1 to GND)")
print("")
print("DISPLAY:")
...
print("Encoder: Rotate=Volume, Press=Mute (Layer 0)")
print("")
